(() => {
  ...
  const posts = {
    ...
    "twelve-frames": {
      title: "谢谢远去的一切",
      meta: "日常片段 · 2024.03.19 · 5 min",
      body: `
        <p>人不是一瞬间才感觉到悲伤的，悲伤其实是缓慢而又持续的。</p>
        <p>它会愈演愈烈，直到痛苦占据我的内心。</p>
        <p>从一开始夜晚的低落，到白天都在发呆，从一开始的做其他事情可以分散注意力，到无论做什么都会被这种情绪感染</p>
        <blockquote>我的生活开始变得模糊了起来，反而我却好像可以摸到我的痛苦了一样。</blockquote>
    }
  };
